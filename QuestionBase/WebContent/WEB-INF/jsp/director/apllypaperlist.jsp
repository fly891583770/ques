         ...
         $(function() {  
            $("#checkAll").click(function() {  
             ...
             $("#aplly").click(function(){
            	 ...
            	 $.get("../director/agreeapllypaper?id="+result,alert("已批准所选的申请"));
             ...
             $("#disagree").click(function(){
            	 ...
            	 $.get("../director/disagreeapllypaper?id="+result,alert("已批准所选的申请"));
