...
<body>
	...
	$(function(){
		...
		$("#chutirenyuan").val('${name}');
		
		$("#add").click(function(){
			location.href = "../teacher/addquestion";
		});
		
		$("#del").click(function(){
			var ti = $("#xuanzhongti").val();
			if(ti==""||ti==null)
			{
				alert("请至少选择一道删除的题");
				return null;
		...
		$("#tijiaoshenghe").click(function(){
			...
			if(ti==""||ti==null)
			{
				...
				$.ajax({
		            type: "get",
		            url:"../teacher/submitquestion?id="+ti,
	...
	<jsp:include page="/WEB-INF/jsp/common/banner.jsp" />
		<form method=post action="searchsubmitquestionlist" target="result">
			<div class="mainpage">
				<table>
								...
								<table style="wdith: 100%; border: 1px">
									...
									<tr>
										<td colspan="2">
											...
											<input type="button" name="add" id="add" value="新题" /> 
											<input type="button" name="del" id="del" value="删除" /> 
											<input type="button" name="tijiaoshenghe" id="tijiaoshenghe" value="提交审核" />
