...
<body>
	...
	$(function(){
		...
		$("#add").click(function(){
			location.href = "../teacher/zujuan";
		});
		
		$("#tijiaoshenghe").click(function(){
			
			
			location.href = "../teacher/submitpaper?id="+$("#xuanzhongti").val();
	...
	<jsp:include page="/WEB-INF/jsp/common/banner.jsp" />
		<form method=post action="searchsubmitpaperlist" target="result">
			<div class="mainpage">
				<table>
							...
							<div class="condition">
								...
								<table style="wdith: 100%; border: 1px">
									...
									<tr>
										...
										<td class="condition-result"><questionBase:chutirenyuan value="question"
