	...
	<jsp:include page="/WEB-INF/jsp/common/banner.jsp" />
		<script language="javascript">
			$(function() {
				if ("${question.name}" != ""
					...
					$("#jiaocaibanben").val(
							"${question.teachingMaterialVersion}");
			...
			function popwin(action) {
				...
				var h = "../common/PageOfficeEditWord?";
		...
		$(function() {
			$("#showWord").click(function(){
			    ...
			    var h = "../common/TitleAndAnswerWord?showAnswer=true";
					...
					<tr vAlign="top">
								...
								<table style="wdith: 100%; border: 1px">
									...
									<tr>
										...
										<questionBase:zhishidian value="question"
												id="zhishidian" name="zhishidian"  disabled = "check" /></td>
									</tr>
									<tr>
										<td class="condition-title">章节</td>
										<td class="condition-result">
											<questionBase:zhangjie value="question"
												id="zhangjie" name="zhangjie" disabled = "check" />
										</td>
									</tr>
									<tr>
										<td colspan="2">
						...
						<td valign="top">试题：
							<div class="ressult">
								<p>
									题干：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
										type="button" value="使用Word编辑题干" onclick="popwin('title');" />
								</p>
								...
								<p>
									答案：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
										type="button" value="使用Word编辑答案" onclick="popwin('answer');" />
								</p>
		...
		<a
			href="../common/PageOfficeEditWord?Action=title&ID=&keepThis=true&TB_iframe=true&height=600&width=750"
			id="pageOfficeNewWord" title="编辑试题" class="thickbox"></a>
