	...
	<jsp:include page="/WEB-INF/jsp/common/banner.jsp" />
	 <script type="text/javascript">  
         $(function() {  
            $("#checkAll").click(function() {  
             ...
             $("#aplly").click(function(){
            	 ...
            	 if(result==""){
            		 ...
            		 $.get("../parent/approvedquestion?id="+result,function(){
            			 alert("已批准所选的申请.");
            			 location.reload();
            		 });
            	 }
			...
			<div class="mainpage">
			学生提交的申请：
				<table class="showtable" width=60%>
					<tr>
						<th width=10%><input type="checkbox" id="checkAll" name="checkAll"  /></th>
						<th width=30%>学生姓名</th>
						<th width=30%>试题预览</th>
					</tr>
					<c:forEach var="u" items="${hash}">
						<c:forEach var="q" items="${u.value}">
							<tr>
								...
								<td><a href="./editquestion?id=${q.code}"><c:out value="${q.summary}" /></a></td>
							</tr>
