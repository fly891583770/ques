...
<body>
	...
	<div id="main">
		...
		<form method=post action="student/searchquestion">
									...
									<tr>
										<td colspan="2">
											<div style="text-align: center">
												<input type="button" name="showWord" id="showWord"
													value="用Word显示" /> &nbsp;&nbsp;&nbsp;&nbsp; <input
													type="button" name="search" id="search" value="返回" />
											</div>
										</td>
									</tr>
								</table>
			...
			<a
				href="../common/PageOfficeReadOnlyWord?Action=title&ID=&keepThis=true&TB_iframe=true&height=600&width=750"
				id="pageOfficeNewWord" title="查看试题" class="thickbox"></a> <a
				href="../common/TitleAndAnswerWord?Action=title&ID=&keepThis=true&TB_iframe=true&height=600&width=800"
				id="TitleAndAnswerWord" title="显示试题" class="thickbox"></a> <a
