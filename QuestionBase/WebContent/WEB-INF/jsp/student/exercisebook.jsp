...
<script type="text/javascript">
	...
	function del(id)
	{
		window.parent.location = "delexercisebook?id="+id;
	}
</script>
</head>
<body>
...
<table class="showtable" width="60%" border="0">
	<th width="30%">习题册名称</th><th  width="30%">习题册状态</th><th width="10%">删除</th>
	<c:forEach var="u" items="${exercisebooks}">
		<tr>
			<td>
			...
			<td>状态（代码）</td>			
			<td>
				<a href="javascript:del(${u.code})"><img src="../../QuestionBase/img/delete.png" /></a>
			</td>
		</tr>
	</c:forEach>
</table>
